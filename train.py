...
def handle_visualization_logging_checkpointing(
    ...
    save_latest_freq, save_by_iter, debug, debug_data_size
):
    """
...
@click.option('--seghead', default=['unet_baseline', 'unet_plus', 'unet_swt', 'unet_ssm', 'unet_fft','unet_adv','unet_adv2','unet_wave'], help='name of seghead')
...
@click.option('--n-epochs-decay', type=int, default=10,
...
@click.option('--save-epoch-freq', default=1,
